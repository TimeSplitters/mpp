...
<section id="block_contact_infos" class="col-xs-12 col-md-3 text-center">
	<div class="icon-question-circle icon-3x"></div>
	<div>
		<span>{l s='Store Information' mod='blockcontactinfos'}</span>
