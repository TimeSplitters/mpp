...
*}
<section id="social_block" class="col-md-3 text-center">
    <div class="icon-users icon-3x"></div>
    <br/>
    <span>{l s='Retrouvez-nous sur les réseaux sociaux !' mod='blocksocial'}</span>
    <ul>
        {if isset($facebook_url) && $facebook_url != ''}
            <li class="facebook">
                <a class="_blank" href="{$facebook_url|escape:html:'UTF-8'}">
                    <span class="icon-facebook-square icon-2x"></span>
                </a>
            </li>
        {/if}
        {if isset($twitter_url) && $twitter_url != ''}
            <li class="twitter">
                <a class="_blank" href="{$twitter_url|escape:html:'UTF-8'}">
                    <span class="icon-twitter-square icon-2x"></span>
                </a>
            </li>
        {/if}
        ...
        {if isset($pinterest_url) && $pinterest_url != ''}
            <li class="pinterest">
                <a class="_blank" href="{$pinterest_url|escape:html:'UTF-8'}">
                    <span class="icon-pinterest-square icon-2x"></span>
                </a>
            </li>
        {/if}
