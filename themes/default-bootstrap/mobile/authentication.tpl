        ...
        <div class="col-xs-12 col-sm-6">
            <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box">
                ...
                <div class="form_content clearfix">
                    <div>{l s='Please enter your email address to create an account.'}</div>
                    <div class="alert alert-danger" id="create_account_error" style="display:none"></div>
                    <div class="form-group create_email">
                        <label for="email_create">{l s='Email address'}</label>
                        <input type="email" class="is_required validate account_input form-control" data-validate="isEmail" id="email_create" name="email_create" value="{if isset($smarty.post.email_create)}{$smarty.post.email_create|stripslashes}{/if}" placeholder="{l s='Entrez votre adresse email'}" />
                        <div id="create_email" class="error_message"></div>
                    </div>
                    <div class="submit">
                        <div id="create_general_error" class="error_message"></div>
            ...
            <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
                ...
                <div class="form_content clearfix">
                    <div class="form-group login_email">
                        ...
                        <div id="login_email" class="error_message"></div>
                    </div>
                    <div class="form-group login_passwd">
                        <label for="passwd">{l s='Password'}</label>
                        <input class="is_required validate account_input form-control" type="password" data-validate="isPasswd" id="passwd" name="passwd" value="" placeholder="{l s='Entrez votre mot de passe'}" />
                        <div id="login_passwd" class="error_message"></div>
                    </div>
                    ...
                    <div class="submit">
                        <div id="login_general_error" class="error_message"></div>
                        {if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
        ...
        <form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std clearfix">
            <div class="box">
                <div id="opc_account_form" style="display: block; ">
                    ...
                    <div class="required"><sup>*</sup>{l s='Required field'}</div>
                    <!-- Account -->
                    <div class="required form-group">
                        <label for="guest_email">{l s='Email address'} <sup>*</sup></label>
                        <input type="text" class="is_required validate form-control" data-validate="isEmail" id="guest_email" name="guest_email" value="{if isset($smarty.post.guest_email)}{$smarty.post.guest_email}{/if}" placeholder="{l s='Entrez votre adresse email'}" />
                    </div>
                    <div class="cleafix gender-line form-group">
                        <label>{l s='Genre'}:</label>
                    ...
                    <div class="required form-group">
                        ...
                        <input type="text" class="is_required validate form-control" data-validate="isName" id="firstname" name="firstname" value="{if isset($smarty.post.firstname)}{$smarty.post.firstname}{/if}" placeholder="{l s='Entrez votre prénom'}" />
                    </div>
                    <div class="required form-group">
                        <label for="lastname">{l s='Last name'} <sup>*</sup></label>
                        <input type="text" class="is_required validate form-control" data-validate="isName" id="lastname" name="lastname" value="{if isset($smarty.post.lastname)}{$smarty.post.lastname}{/if}" placeholder="{l s='Entrez votre nom'}" />
                    </div>
                    <div class="form-group date-select" id="new_account_birth">
                    ...
                    {foreach from=$dlv_all_fields item=field_name}
                        ...
                        {elseif $field_name eq "address2"}
                            <div class="form-group is_customer_param">
                                ...
                                <input type="text" class="form-control" name="address2" id="address2" value="{if isset($smarty.post.address2)}{$smarty.post.address2}{/if}" placeholder="{l s='Entrez votre adresse postale (compléments)'}" />
                            </div>
                        ...
                        {elseif $field_name eq "city"}
                            <div class="required form-group">
                                ...
                                <input type="text" class="form-control" name="city" id="city" value="{if isset($smarty.post.city)}{$smarty.post.city}{/if}" placeholder="{l s='Entrez votre ville'}" />
                            </div>
                    ...
                    <div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
                        ...
                        <input type="tel" class="form-control" name="phone_mobile" id="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{/if}" placeholder="{l s='Entrez votre numéro de téléphone'}" />
                    </div>
                    ...
                    <div id="opc_invoice_address"  class="unvisible">
                        ...
                        {if isset($one_phone_at_least) && $one_phone_at_least}
                            <div class="inline-infos required is_customer_param">{l s='You must register at least one phone number.'}</div>
                        {/if}
                        <div class="form-group is_customer_param">
...
{else}
    <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box">
        ...
        <div class="account_creation">
            ...
            <div class="form-group">
                <label>{l s='Date of Birth'}</label>
                <div class="row gutter-10" id="creation_birth">
                    <div class="col-xs-4">
                        <strong>{l s='Jour'}</strong>
                        <select id="days" name="days" class="form-control">
                            <option value="">-</option>
                            {foreach from=$days item=day}
                                <option value="{$day}" {if ($sl_day == $day)} selected="selected"{/if}>{$day}&nbsp;&nbsp;</option>
        ...
        {if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
            <div class="account_creation">
                ...
                {if isset($one_phone_at_least) && $one_phone_at_least}
                    ...
                    <div class="inline-infos required">** {l s='You must register at least one phone number.'}</div>
                {/if}
        ...
        <div class="submit clearfix">
            ...
            <div class="pull-right required"><span><sup>*</sup>{l s='Required field'}</span></div>
        </div>
    </form>
{/if}
{strip}
