...
{if !empty($display_header)}{include file="$tpl_mobile_uri./header.tpl" HOOK_MOBILE_HEADER=$HOOK_MOBILE_HEADER}{/if}
<div class="row main" id="center_column">
	{if !empty($template)}{$template}{/if}
</div>

{if !empty($display_footer)}{include file="$tpl_mobile_uri./footer.tpl"}{/if}
