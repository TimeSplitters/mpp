            ...
            <div class="pb-right-column col-xs-12">
                {if ($product->show_price && !isset($restricted_country_mode)) || isset($groups) || $product->reference || (isset($HOOK_PRODUCT_ACTIONS) && $HOOK_PRODUCT_ACTIONS)}
                    ...
                    <form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if}
                        ...
                        {if $product->id == 8}
                            {include file="$tpl_dir/mobile/product_book_form.tpl"}
                        {elseif $product->id == 9}
                            {include file="$tpl_dir/mobile/product_film_form.tpl"}
                        {elseif $product->id == 10}
                            {include file="$tpl_dir/mobile/product_music_form.tpl"}
                        {/if}
                            ...
                            <div class="row text-center gutter-10">
                                <div class="col-xs-4">
                                    {if $product->id == 8}
                                        ...
                                        <span>Un livre</span>
                                    {elseif $product->id == 9}
                                        <span class="icon-film icon-xl"></span>
                                        <br/>
                                        <span>Un film</span>
                                    {elseif $product->id == 10}
                                        <span class="icon-music icon-xl"></span>
                                        <br/>
                                        <span>Un album</span>
                                    {/if}
                                </div>
