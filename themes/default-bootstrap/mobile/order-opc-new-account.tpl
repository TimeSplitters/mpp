		...
		<fieldset>
			...
			<div id="login_form_content" style="display:none;">
				...
				<p>
					...
					<button type="submit" id="SubmitLogin" name="SubmitLogin" class="btn btn-default"><span><i class="icon-lock left"></i>{l s='Sign in'}</span></button>
				</p>
			</div>
		</fieldset>
	</form>
			...
			<div class="box">
				...
				<div id="opc_account_form" class="unvisible">
					...
					<div class="opc-add-save clearfix">
						...
						<button type="submit" name="submitAccount" id="submitAccount" class="btn btn-default"><span>{l s='Save'}<i class="icon-chevron-right right"></i></span></button>
